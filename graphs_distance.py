...
#percorrer a lista de componentes, para cada nó do componente atual
#verificar a distancia para os nós de todos os outros componentes.
#escolher o nó com a menor distância

#percorre todos os nós do primeiro componente
for g in graphs[0]:
    #percorre a lista de todos os componentes
    for b in graphs[1:]:
        print(b)
        break
        ...
        for i in range(len(b)):
            print(b)
            dst = distance.euclidean((g[0],g[1]), ((b[i])[0],(b[i])[1]))
            print(dst)
